 ...
 */
@Library("wgpu") 
public class WGPUSurfaceDescriptor extends StructObject {
	...
	/// C type : const WGPUChainedStruct*
	@Field(0) 
	public WGPUSurfaceDescriptor nextInChain(Pointer<WGPUChainedStruct > nextInChain) {
	...
	/// C type : const char*
	@Field(1) 
	public WGPUSurfaceDescriptor label(Pointer<Byte > label) {
		this.io.setPointerField(this, 1, label);
		return this;
	}
	public WGPUSurfaceDescriptor(Pointer pointer) {
		super(pointer);
	}
}
